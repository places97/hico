...
import kr.go.util.GeneralizationUtil;
import kr.go.util.MaskDataUtil;
import kr.go.util.PseudonymUtil;
 ...
 * </pre>
 * @see     kr.go.util.MaskDataUtil
 * @see     kr.go.util.PseudonymUtil
 * @see     kr.go.util.GeneralizationUtil
 */
@Component
